...
cx q[51],q[70];
measure q[60]->c[0];
barrier q[60],q[5],q[28];
measure q[58]->c[1];
barrier q[58],q[3],q[23];
measure q[63]->c[2];
barrier q[63],q[0],q[20];
measure q[65]->c[3];
barrier q[65],q[6],q[27];
measure q[64]->c[4];
barrier q[64],q[1],q[42];
measure q[59]->c[5];
barrier q[59],q[4],q[41];
measure q[62]->c[6];
barrier q[62],q[2],q[39];
measure q[61]->c[7];
barrier q[61],q[7],q[38];
...
h q[35];
measure q[34]->c[18];
barrier q[34],q[27],q[30];
measure q[33]->c[19];
barrier q[33],q[19],q[20];
measure q[32]->c[20];
barrier q[32],q[22],q[23];

//--------------- Layer: 68 ---------------//
measure q[35]->c[21];
barrier q[35],q[28],q[31];
cx q[27],q[30];
x q[34];
cx q[19],q[20];
x q[33];
